...
class Snail(Module):
    ...
    def __init__(self, n: int, k: int, dataset: str):
        ...
        if dataset == 'omniglot':
            ...
            self.embedding_network = Sequential(torch.hub.load('pytorch/vision:v0.6.0', 'mobilenet_v2', pretrained=True), BatchNorm1d(1000), Dropout(0.83), LeakyReLU(.3), Linear(1000, 300))
