...
class MetaLearningDataLoader(ABC):
    ...
    def __init__(self, batch_size: int, n: int, n_s: int,
...
class MiniImagenetDataLoader(MetaLearningDataLoader):
    ...
    def pull_data(self):
        pull_data_miniimagenet(False)

    def _train_dataset(self):
        return MiniImageNetMetaLearning(MINIIMAGENETFOLDER / 'train', self.n, self.n_s, False)

    def _val_dataset(self):
        return MiniImageNetMetaLearning(MINIIMAGENETFOLDER / 'val', self.n, self.n_s, False)

    def _test_dataset(self):
        return MiniImageNetMetaLearning(MINIIMAGENETFOLDER / 'test', self.n, self.n_s, False)
