...
train-miniimagenet-n5-k1:
	python3 train.py --dataset='miniimagenet' --n=5 --k=1 --epochs=100 --batch-size=32 --trainsize=10000 --testsize=64 --device='cuda:1' --evalength=64 --lr=10e-4 --track-weights=True --train-weights-freq=1000 --random-rotation=False --trainpbar=False > train-log.txt 2> train-err.txt
